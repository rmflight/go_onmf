...
if any(any(X<0)) && (strcmp(option.algorithm,'nmfnnls')||strcmp(option.algorithm,'nmfrule')||strcmp(option.algorithm,'sparsenmfnnls')||strcmp(option.algorithm,'orthnmfrule'))
