...
**WE HAVE FOUND THEM**. The propagated terms have **NO** overlap with the original
terms, and are children of the original terms. Just to be sure, we will also
compare the propagated terms to the `GOALL` annotation, which would be all of
